Ext.define('Ext.app.GridPortlet', {
	...
	Also, check initComponenet(), getSubscriptionTopics(), notified() methods to get complete implementation
	*/
	mixins: {
	...
	*/
	notified : function(notifierId, topicId, message) {
    	if (topicId == Ext.ux.messaging.Constants.topics.RELOAD) {
				this.curData = (this.curData == this.myData1) ? this.myData : this.myData1;
    			this.store.loadData(this.curData);			
		}
    },
